...
namespace ThinSdk.Neo.SmartContract
{
    /// <summary>
    /// +------------+-----------+------------------------------------------------------------+
    ...
    public class NefFile : ISerializable
    {
        ...
        public void Deserialize(BinaryReader reader)
        {
            ...
            if (new UInt160(Conversion.CalcHash160(Script)) != ScriptHash)
            {
        ...
        public static NefFile LoadNef(string nefFilePath)
        {
            FileInfo info = new FileInfo(nefFilePath);
